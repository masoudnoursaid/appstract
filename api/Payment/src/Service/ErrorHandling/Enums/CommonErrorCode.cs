...
public enum CommonErrorCode
{
    ...
    [ErrorType(BackendErrorType.Security)] ValidationFailed = 800,
    ...
    [ErrorType(BackendErrorType.Security)] ModelBindingFailed = 804,

    [ErrorType(BackendErrorType.BusinessLogic)]
    SessionRevoked = 805,

    [ErrorType(BackendErrorType.Security)] SecurityError = 900,

    [ErrorType(BackendErrorType.ApplicationFailure)]
    EntityError = 1000,

    [ErrorType(BackendErrorType.BusinessLogic)]
    GetWayNotImplementedYet = 1100
}