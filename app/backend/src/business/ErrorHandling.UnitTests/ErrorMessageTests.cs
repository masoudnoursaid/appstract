...
{
    private static List<Type> BackendErrorEnums => GetErrorEnumsOfAssemblyContaining(typeof(DependencyInjection));
    ...
    public void AllBackendErrorCodesEnumValuesHaveValidErrorMessages()
    {
        ...
        if (!string.IsNullOrEmpty(errors.ToString()))
        {
            ...
            Assert.False(false, string.Join(Environment.NewLine, errors));
        }
